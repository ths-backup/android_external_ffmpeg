...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=./android/armv7-a --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/data/android/android-ndk-r5c/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-gcc --cross-prefix=/data/android/android-ndk-r5c/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi- --nm=/data/android/android-ndk-r5c/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-nm --sysroot=/data/android/android-ndk-r5c/platforms/android-9/arch-arm/ --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums  -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=vfpv3-d16 -marm -march=armv7-a  ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=/data/android/android-ndk-r5c/platforms/android-9/arch-arm//usr/lib -L/data/android/android-ndk-r5c/platforms/android-9/arch-arm//usr/lib  -nostdlib -lc -lm -ldl -llog' --enable-parsers --disable-encoders --enable-decoders --disable-muxers --enable-demuxers --enable-swscale --disable-ffplay --disable-ffprobe --disable-ffserver --enable-network --enable-indevs --disable-bsfs --disable-filters --enable-protocols --enable-asm
...
SRC_PATH="/data/android/ffmpeg_dice110628"
SRC_PATH_BARE=/data/android/ffmpeg_dice110628
BUILD_ROOT="/data/android/ffmpeg_dice110628"
CC_IDENT=gcc 4.4.0 (GCC)
ARCH=arm
CC=/data/android/android-ndk-r5c/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-gcc
AS=/data/android/android-ndk-r5c/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-gcc
LD=/data/android/android-ndk-r5c/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-gcc
DEPCC=/data/android/android-ndk-r5c/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/data/android/android-ndk-r5c/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-ar
RANLIB=/data/android/android-ndk-r5c/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/data/android/android-ndk-r5c/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-strip
CPPFLAGS= --sysroot=/data/android/android-ndk-r5c/platforms/android-9/arch-arm/ -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
...
CC_O=-o $@
LDFLAGS= -Wl,-rpath-link=/data/android/android-ndk-r5c/platforms/android-9/arch-arm//usr/lib -L/data/android/android-ndk-r5c/platforms/android-9/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog --sysroot=/data/android/android-ndk-r5c/platforms/android-9/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
