...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=./android/armv7-a --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/home/inisoft/android-ndk/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-gcc --cross-prefix=/home/inisoft/android-ndk/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi- --nm=/home/inisoft/android-ndk/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-nm --sysroot=/home/inisoft/android-ndk/platforms/android-8/arch-arm/ --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums  -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=/home/inisoft/android-ndk/platforms/android-8/arch-arm//usr/lib -L/home/inisoft/android-ndk/platforms/android-8/arch-arm//usr/lib  -nostdlib -lc -lm -ldl -llog' --enable-parsers --disable-encoders --enable-decoders --disable-muxers --enable-demuxers --enable-swscale --disable-ffplay --disable-ffprobe --disable-ffserver --enable-network --enable-indevs --disable-bsfs --disable-filters --enable-protocols --enable-asm --enable-neon
...
SRC_PATH="/home/inisoft/Downloads/rockplayer_ffmpeg_git_20100418"
SRC_PATH_BARE=/home/inisoft/Downloads/rockplayer_ffmpeg_git_20100418
BUILD_ROOT="/home/inisoft/Downloads/rockplayer_ffmpeg_git_20100418"
CC_IDENT=gcc 4.4.0 (GCC)
ARCH=arm
CC=/home/inisoft/android-ndk/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-gcc
AS=/home/inisoft/android-ndk/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-gcc
LD=/home/inisoft/android-ndk/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-gcc
DEPCC=/home/inisoft/android-ndk/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/home/inisoft/android-ndk/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-ar
RANLIB=/home/inisoft/android-ndk/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/home/inisoft/android-ndk/toolchains/arm-eabi-4.4.0/prebuilt/linux-x86/bin/arm-eabi-strip
CPPFLAGS= --sysroot=/home/inisoft/android-ndk/platforms/android-8/arch-arm/ -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS= -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8  -fPIC -g
CC_O=-o $@
LDFLAGS= -Wl,-rpath-link=/home/inisoft/android-ndk/platforms/android-8/arch-arm//usr/lib -L/home/inisoft/android-ndk/platforms/android-8/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog --sysroot=/home/inisoft/android-ndk/platforms/android-8/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
...
LAVF_TESTS=
LAVFI_TESTS=
#crop crop_scale crop_scale_vflip crop_vflip null pixdesc_le pixfmts_copy_le pixfmts_crop_le pixfmts_hflip_le pixfmts_null_le pixfmts_pad_le pixfmts_scale_le pixfmts_vflip_le scale200 scale500 vflip vflip_crop vflip_vflip 
